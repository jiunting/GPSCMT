#The function that generates static forward model
import glob
import numpy as np
import threading
import os
...
#project_name='Forward_M6.9inv' #create a folder under working dir
...
#grdfile='USGSM5.4.grd' #source location
grdfile='test.grid' #source location

srcfile='test.src' #source file
#stafile='test.sta' #recording stations
#stafile='TWGPS_test.sta' #recording stations
stafile='TPN_All_filt.sta' #recording stations
#grdfile='Inv6.9.grd' #source location
#srcfile='Inv6.9.src' #source file
#stafile='Inv6.9.sta' #recording stations
...
if __name__ == "__main__":
    print('Usage: set','make_forward.[home/project_name/fk_home/grdfile/srcfile/stafile/modelpath/nprocess/SRCtype]')
    print('Run model:','make_forward.run_forward()')
